---
layout: person
title: Dr. Edmund Ilimoan Yamba (PI)
pronouns: he/him
current_position: |
...
Dr. Yamba has extensive expertise in **university teaching and curriculum design**, **research design**, **grant writing and project management**, **scientific writing and peer review**, and **graduate student supervision**. His technical skills include **data science**, **advanced scientific computing**, **data analysis and mining**, **statistics**, and **visualization**. He is proficient in programming languages such as **FORTRAN**, **Python**, **R**, and **Shell Scripting**, and works efficiently in **Linux-based systems** using **LaTeX** for scientific writing.

Dr. Yamba’s multidisciplinary background spans **climate-sensitive health modeling**, **biometeorology**, **bioclimatology**, **biostatistics**, and **climate change and human health**. His current research focuses on understanding how **climate change and variability** drive the transmission of **vector-borne diseases**, **emerging and re-emerging infectious diseases**, **heat-related illnesses** (such as heat stress, stroke, exhaustion, and mental health challenges), and **air pollution impacts** on respiratory health.

He is actively engaged in several **high-impact research projects** addressing global and regional climate–health challenges:

- 🧠 **Co-Investigator**, *Responsible AI for Developing a Robust Public Health Surveillance System (RAPID-VBP)* — *December 2023 to November 2027*, funded by the **Global South AI4PEP Network**.  
  Focus: Leveraging AI to enhance early detection and prediction of vector-borne zoonotic pathogens.  

- 🌡️ **Co-Principal Investigator (Co-PI)**, *Building a Climate Cohort to Monitor Health Impacts of Climate Change in Ghana* — *February 2024 to March 2027*, funded by the **Wellcome Trust**.  
  Focus: Developing a comprehensive climate–health cohort to assess long-term public health impacts.  
...
Dr. Yamba welcomes partnerships that advance scientific knowledge and improve human well-being in the face of climate change.
